...
for i, U in enumerate(U_array):
    t_LightVeriFL  = pickle.load(open('./results/LightVeriFL_imp_N100'+'_U' + str(U)+'_d10000', 'rb'))
    t_VeriFL  = pickle.load(open('./results/VeriFL_imp_N100'+'_U' + str(U)+'_d10000', 'rb'))
...
plt.grid()
plt.legend()
plt.savefig('./plots/total_runtime_d10000_drop_imp.png',dpi=300, bbox_inches = "tight")
plt.show()
...
plt.grid()
plt.legend()
plt.savefig('./plots/aggr_runtime_d10000_drop_imp.png',dpi=300, bbox_inches = "tight")
plt.show()
...
plt.grid()
plt.legend()
plt.savefig('./plots/verification_runtime_d10000_drop_imp.png',dpi=300, bbox_inches = "tight")
plt.show()